...
class MasculineSenior extends StatefulWidget {
  const MasculineSenior({super.key});

  @override
  _MasculineSeniorState createState() => _MasculineSeniorState();
}

class _MasculineSeniorState extends State<MasculineSenior> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Masculine Senior')),
      body: FutureBuilder(
