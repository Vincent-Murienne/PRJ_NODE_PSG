...
class FeminineSenior extends StatefulWidget {
  ...
  @override
  _FeminineSeniorState createState() => _FeminineSeniorState();
}

class _FeminineSeniorState extends State<FeminineSenior> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Feminine Senior')),
      body: FutureBuilder(
